...
if __name__ == '__main__':
    ...
    pickle.dump(bm25_title, open('bm25_title.pkl', 'wb'))

    bm25_synopsis = BM25()
    bm25_synopsis.fit(parsed_data['synopsis'])
    pickle.dump(bm25_synopsis, open('bm25_synopsis.pkl', 'wb'))

    # bm25_background = BM25()
    # bm25_background.fit(parsed_data['background'])
    # pickle.dump(bm25_background, open('bm25_background.pkl', ' wb'))
